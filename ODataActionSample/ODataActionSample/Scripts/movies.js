...
window.viewModel = (function () {
    ...
    self.checkoutMany = function () {
        ...
        ajaxRequest("post", feedUrl + "/ODataActionSample.Model.CheckOutMany", data)
            .done(function (result) {
    ...
    function movie(data, parent) {
        ...
        function updateMovie(data) {
            ...
            if (data["#ODataActionSample.Model.CheckOut"]) {
                self.checkoutUrl(data["#ODataActionSample.Model.CheckOut"].target);
            }
            else {
                self.checkoutUrl(null);
            }
            if (data["#ODataActionSample.Model.Return"]) {
                self.returnMovieUrl(data["#ODataActionSample.Model.Return"].target);
            }
            else {
